...
urlpatterns = [
    ...
    path('grid/', views.employee_grid, name='employee_grid'),
    ...
    path('manager/add/', views.add_employee, name='add_employee'),
    path('manager/edit/<int:pk>/', views.edit_employee, name='edit_employee'),
    path('manager/delete/<int:pk>/', views.delete_employee, name='delete_employee'),
    path('manager/export/', views.export_attendance_csv, name='export_employee_csv'),
